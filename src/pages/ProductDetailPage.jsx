      ...
      >
        ...
        >
          ...
          <Grid item xs={12} md={7} sx={{ width: "100%" }}>
            <Typography variant="h5" component="h4" gutterBottom sx={{ fontWeight: 700, letterSpacing: 0.5, mb: 2 }}>
              {product.title}
            </Typography>
            ...
            <Typography variant="body1" paragraph sx={{ fontSize: "1.08rem", color: "text.secondary", mb: 3 }}>
              {product.description}
            </Typography>
